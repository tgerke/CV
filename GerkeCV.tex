...
\years{2019}Ad-hoc reviewer (8 manuscripts): PeerJ; Cancer Epidemiology, Biomarkers \& Prevention (4); Cancer Research; JNCI, CHEST (2)\\
...
\item{} Khan S$^*$, Caldwell J$^*$, Wilson KM, Gonzalez-Feliciano A, Peisch S, Pernar CH, Graff RE, Giovannucci E, Mucci LA, \underline{{\bf Gerke TA$^{**}$}}, Markt SC$^{**}$. Baldness and risk of prostate cancer in the Health Professionals Follow-Up Study. Cancer Epidemiol Biomarkers Prev; In press.
