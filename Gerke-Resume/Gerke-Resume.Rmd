...
tribble(
  ...
  "Assistant Member, Department of Cancer Epidemiology", "2016--present", "H. Lee Moffitt Cancer Center & Research Institute", "Tampa, FL", "Direct academic research lab with emphasis in: (i) developing modernized data science workflows for molecular epidemiology research; (ii) causal inference for decision science and real world evidence studies; (iii) reproducible data science frameworks"
) %>% 
...
tribble(
  ~ Position, ~ Year, ~ Institution, ~ Where, ~Why,
  "Scientific Director, Collaborative Data Services", " ", " ", " ", "Provide scientific and technical leadership for Moffitt's research data provisioning hub. Key initiatives include: (i) transition a traditionally Excel-based data group to modern R frameworks with git versioning; (ii) enhance interfacing with biostatistics/bioinformatics end-users to deliver analytically-ready data"
) %>% 
  detailed_entries(Position, Year, Institution, Where, Why)
```
