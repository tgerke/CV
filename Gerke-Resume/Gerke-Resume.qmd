...
section-five-text: |
  ...
  \begin{itemize}
      \item Transformed the data access layer as the agile product owner of cloud-based data marts (AWS/Snowflake) and associated informatics tools (RStudio/Python/Shiny)
      \item Lead teams to provide the foundation for predictive analytics, pipelines for ML/AI applications, and data sharing partnerships
  \end{itemize}
  \divider
