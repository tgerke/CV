...
\begin{document}
    ...
    \photoL{4cm}{$photo-path$}

    \personalinfo{
        \email{$email$}\smallskip
        \ifstrempty{$phone$}{}{\phone{$phone$}}
        \ifstrempty{$location$}{}{\location{$location$}}\\
        \ifstrempty{$linkedin$}{}{\linkedin{$linkedin$}}
        \ifstrempty{$github$}{}{\github{$github$}}
        \ifstrempty{$homepage$}{}{\homepage{$homepage$}}
        \ifstrempty{$medium$}{}{\medium{$medium$}}
        \ifstrempty{$npm$}{}{\npm{$npm$}}
        \ifstrempty{$dev$}{}{\dev{$dev$}}
        \ifstrempty{$orcid$}{}{\orcid{$orcid$}}
        \ifstrempty{$scholar$}{}{
        \mbox{\textcolor{accent}{\normalfont \faGraduationCap}~\href{https://scholar.google.com/citations?user=$scholar$}{Google Scholar}\hspace{2em}}
        }
    ...
    \begin{paracol}{2}
        % ----- SECTION ONE -----
        \cvsection{$section-one$}
            $section-one-text$
        % ----- SECTION ONE -----
        
        % ----- SECTION TWO -----
        \cvsection{$section-two$}
            $section-two-text$
            \smallskip
        % ----- SECTION TWO -----
        
        % ----- SECTION THREE -----
        \cvsection{$section-three$}
            $section-three-text$
        % ----- SECTION THREE -----
